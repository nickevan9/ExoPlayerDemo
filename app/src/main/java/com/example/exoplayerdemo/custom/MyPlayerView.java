 ...
 * during playback, and displays playback controls using a {@link MyPlayerControlView}.
 *
 ...
 * inflated by the child {@link MyPlayerControlView}. See below for more details.
 * <ul>
 * <li>Corresponding method: None
 * <li>Default: {@code R.layout.exo_player_control_view1}
 * </ul>
 * <li>All attributes that can be set on {@link MyPlayerControlView} and {@link MyTimeBar} can
 * also be set on a PlayerView, and will be propagated to the inflated {@link
 * MyPlayerControlView} unless the layout is overridden to specify a custom {@code
 ...
 * {@link MyPlayerControlView}. Ignored if an {@code exo_controller} view exists.
 * <ul>
 * <li>Type: {@link View}
 * </ul>
 * <li><b>{@code exo_controller}</b> - An already inflated {@link MyPlayerControlView}. Allows use
 * of a custom extension of {@link MyPlayerControlView}. {@link MyPlayerControlView} and {@link
 * MyTimeBar} attributes set on the PlayerView will not be automatically propagated
 * through to this instance. If a view exists with this id, any {@code
 * exo_controller_placeholder} view will be ignored.
 * <ul>
 * <li>Type: {@link MyPlayerControlView}
 * </ul>
...
public class MyPlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
    ...
    @Nullable
    public final MyPlayerControlView controller;
        ...
        if (contentFrame != null && surfaceType != SURFACE_TYPE_NONE) {
            ...
            switch (surfaceType) {
                ...
                case SURFACE_TYPE_MONO360_VIEW:
                    SphericalGLSurfaceView sphericalSurfaceView = new SphericalGLSurfaceView(context);
    ...
    /**
     * Set the {@link MyPlayerControlView.VisibilityListener}.
     *
     * @param listener The listener to be notified about visibility changes.
     */
    public void setControllerVisibilityListener(MyPlayerControlView.VisibilityListener listener) {
        Assertions.checkState(controller != null);
